...
- Kategorická dlaždice má varianty `standard` (fotka/ikona, název, počet, podkategorie, „Zobrazit vše") a `kompaktni` (bílá plocha, fotka 48 × 48 vlevo, název a počet, min-height 72 — bez podkategorií).
